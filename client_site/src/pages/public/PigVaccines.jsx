...
const PigVaccines = () => {
  ...
  const fetchVaccines = async () => {
    try {
      ...
      const response = await publicService.getPigVaccines(params);
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 flex flex-col">
      ...
      <div className="flex flex-1 relative">
        ...
        <main className="flex-1 w-full md:w-[calc(100%-16rem)] container mx-auto px-4 py-8">
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-gray-800 mb-2">Pig Vaccines</h1>
            <p className="text-gray-600">Comprehensive guide to pig vaccines and vaccination schedules</p>
          </div>
