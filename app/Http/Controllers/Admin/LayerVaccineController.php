...
class LayerVaccineController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $vaccine = LayerVaccine::create($validated);

        return response()->json([
            'message' => 'Layer vaccine created successfully',
            'data' => $vaccine,
        ], 201);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json([
            'message' => 'Layer vaccine updated successfully',
            'data' => $vaccine,
        ]);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            'message' => 'Layer vaccine deleted successfully',
        ]);
    }
}
